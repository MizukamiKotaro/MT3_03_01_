...
MyVector2 Ease::UseEase(const MyVector2& a, const MyVector2& b, float t) {
	MyVector2 result = {};
...
MyVector3 Ease::UseEase(const MyVector3& a, const MyVector3& b, float t) {
	MyVector3 result = {};
...
MyVector2 Ease::UseEase(const MyVector2& a, const MyVector2& b, int nowFrame, int maxFrame, EaseType easeType, int index) {
	float t = MakeEaseT(nowFrame, maxFrame, easeType, index);

	MyVector2 result = UseEase(a, b, t);

	return result;
}

MyVector2 Ease::UseEase(const MyVector2& a, const MyVector2& b, float t, EaseType easeType, int index) {
	float easeT = MakeEaseT(t, easeType, index);

	MyVector2 result = UseEase(a, b, easeT);

	return result;
}

MyVector3 Ease::UseEase(const MyVector3& a, const MyVector3& b, int nowFrame, int maxFrame, EaseType easeType, int index) {
	float t = MakeEaseT(nowFrame, maxFrame, easeType, index);

	MyVector3 result = UseEase(a, b, t);

	return result;
}

MyVector3 Ease::UseEase(const MyVector3& a, const MyVector3& b, float t, EaseType easeType, int index) {
	float easeT = MakeEaseT(t, easeType, index);

	MyVector3 result = UseEase(a, b, easeT);

	return result;
}

MyVector2 Ease::EaseInMove(MyVector2& OwnPos, MyVector2& tmp1, MyVector2& tmp2, int& nowFrame, int& maxFrame) {
...
MyVector2 Ease::EaseOutMove(MyVector2& OwnPos, MyVector2& tmp1, MyVector2& tmp2, int& nowFrame, int& maxFrame) {
